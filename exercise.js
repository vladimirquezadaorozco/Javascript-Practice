...
let h1ElementById = document.getElementById('h1-element')
...
second_P_Selector = document.querySelector('.second-p-element')
console.dir(second_P_Selector)


// 5. BONUS TASK: Try changing the text content of the <p> element
//    you selected in (4) and set it to any other text of your choice

second_P_Selector.textContent = "Hello I modified this text!"